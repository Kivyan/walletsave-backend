  ...
  return (
    <div className="min-h-screen w-full bg-neutral-100 dark:bg-neutral-900 flex items-center justify-center py-8">
      ...
      <div className="auth-container w-full max-w-md mx-auto px-4 pb-4 pt-2 flex flex-col items-center justify-center relative">
        ...
        {/* Carteira com animação otimizada para evitar bugs de renderização */}
        <div className="mb-6 flex justify-center">
          <div className="relative" style={{ width: "220px", height: "220px" }}>
            {/* Contêiner principal - com tamanho maior que o necessário */}
            <motion.div 
            ...
            >
              ...
              <div className="w-48 h-48 bg-neutral-200 dark:bg-neutral-800 rounded-xl shadow-lg flex items-center justify-center">
                {/* Ícone da carteira com animação */}
                <motion.div
              ...
              {/* Contêiner exclusivo para as moedas */}
              <div className="absolute bottom-6 left-0 w-full">
                <div className="relative h-20 mx-auto flex justify-center">
                  {/* Moeda 1 */}
                  <motion.div
                    className="absolute bottom-0 left-5 w-10 h-10 rounded-full bg-gradient-to-br from-yellow-300 to-yellow-500 shadow-lg flex items-center justify-center border-2 border-yellow-200 dark:border-yellow-400"
                    animate={{ 
                      y: [0, -15, 0],
                      rotateZ: [0, 180, 360]
                    }}
                  ...
                  {/* Moeda 2 */}
                  <motion.div
                    className="absolute bottom-0 mx-auto w-11 h-11 rounded-full bg-gradient-to-br from-amber-300 to-amber-500 shadow-lg flex items-center justify-center border-2 border-amber-200 dark:border-amber-400"
                    animate={{ 
                      y: [0, -20, 0],
                      rotateZ: [0, -180, -360]
                    }}
                  ...
                  {/* Moeda 3 */}
                  <motion.div
                    className="absolute bottom-0 right-5 w-9 h-9 rounded-full bg-gradient-to-br from-orange-300 to-orange-500 shadow-lg flex items-center justify-center border-2 border-orange-200 dark:border-orange-400"
                    animate={{ 
                      y: [0, -12, 0],
                      rotateZ: [0, 180, 360]
                    }}
              ...
              />
              <motion.div 
                className="absolute top-1/3 left-1/4 w-2 h-2 bg-white rounded-full shadow-lg dark:shadow-[0_0_8px_3px_rgba(255,255,255,0.7)]"
                animate={{ 
                  opacity: [0, 1, 0],
                  scale: [0.8, 1.2, 0.8]
                }}
