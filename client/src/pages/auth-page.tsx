        ...
        <div className="mb-6 flex justify-center">
          <div className="wallet-animation">
            <div className="wallet-box bg-neutral-200 dark:bg-neutral-800 shadow-lg">
              ...
              {/* Moedas com CSS puro */}
              <div className="coin coin-1 dark:border-yellow-400 dark:shadow-yellow-500/30">
                <FontAwesomeIcon icon={faDollarSign} className="text-yellow-800 text-sm dark:text-yellow-100" />
              </div>
              
              <div className="coin coin-2 dark:border-amber-400 dark:shadow-amber-500/30">
                <FontAwesomeIcon icon={faCoins} className="text-amber-800 text-sm dark:text-amber-100" />
              </div>
              
              <div className="coin coin-3 dark:border-orange-400 dark:shadow-orange-500/30">
                <FontAwesomeIcon icon={faMoneyBillWave} className="text-orange-800 text-xs dark:text-orange-100" />
              </div>
              
              {/* Efeitos de brilho */}
              <div className="sparkle-effect sparkle-1 dark:shadow-[0_0_8px_3px_rgba(255,255,255,0.7)]"></div>
              <div className="sparkle-effect sparkle-2 dark:shadow-[0_0_8px_3px_rgba(255,255,255,0.7)]"></div>
              <div className="sparkle-effect sparkle-3 dark:shadow-[0_0_8px_3px_rgba(255,255,255,0.7)]"></div>
            </div>
          </div>
        </div>
