...
export default function AuthPage() {
  ...
  return (
    <div className="responsive-container bg-neutral-100 dark:bg-neutral-900 w-full h-full overflow-hidden">
      ...
      <AutoScaleContainer targetWidth={400} targetHeight={640} minScale={0.75} maxScale={1} className="flex items-center justify-center w-full h-full">
        <div className="content-wrapper w-full max-w-md flex flex-col items-center justify-center">
          ...
          <div className="mb-4 flex justify-center">
            ...
            >
              ...
              <motion.div
                ...
                style={{ fontSize: "calc(2rem + 2vmin)" }}
              >
              ...
              <TabsContent value="login">
                <Form {...loginForm}>
                  <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-3">
                    ...
                    <Button
                      type="submit"
                      className="w-full mt-3 py-2 text-base"
          ...
          <div className="mt-2 text-center text-xs text-neutral-600 dark:text-neutral-400">
            <p>
