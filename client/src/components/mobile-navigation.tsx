...
export function MobileNavigation() {
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-neutral-800 shadow-lg md:hidden z-50 border-t border-neutral-200 dark:border-neutral-700" style={{height: 'auto', position: 'fixed', bottom: 0}}>
